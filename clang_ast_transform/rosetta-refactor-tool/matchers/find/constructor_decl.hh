...
#ifndef INCLUDED_matchers_find_constructor_decl_HH
#define INCLUDED_matchers_find_constructor_decl_HH
...
public:
	ConstructorDeclFinder(clang::tooling::Replacements *Replace);
