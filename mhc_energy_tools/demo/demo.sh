...
../mhc_gen_db.py --fa in/2sak_A.fasta out/2sak_A.wt.pp5.db
...
../mhc_gen_db.py --fa in/2sak_A_native.fasta --aa_csv in/2sak_A.region_muts.csv --peps_out out/2sak_A.region.pep out/2sak_A.region.pp5.db
...
../mhc_gen_db.py --fa in/2sak_A.fasta --pssm in/2sak_A.pssm --pssm_thresh 2 --positions 52-72 --lock 54,55,58,60,61 --res_out out/2sak_A.52-72.res --chain A out/2sak_A.52-72.pssm.pp5.db

../mhc_gen_db.py --fa in/1eer_A.fasta --pssm in/1eer_A.pssm --pssm_thresh 2 --positions 140-160 --lock 150,151,155 --res_out out/1eer_A.140-160.res --chain A out/1eer_A.140-160.pssm.pp5.db

../mhc_gen_db.py --fa in/3r2x_C.fasta --pssm in/3r2x_C.pssm --pssm_thresh 2 --positions 45-65 --lock 48,51,52,55,56,58,64 --res_out out/3r2x_C.45-65.res --chain C out/3r2x_C.45-65.pssm.pp5.db
