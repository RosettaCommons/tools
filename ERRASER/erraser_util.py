...
def rosetta_bin_path(exe_file, rosetta_folder = "") :
    ...
    exe_folder = rosetta_folder + "/main/rosetta_source/bin/" #Default Rosetta folder structure
...
def rosetta_database_path(rosetta_folder = "") :
    ...
    database_folder = rosetta_folder + "/main/rosetta_database/" #Default Rosetta folder structure
