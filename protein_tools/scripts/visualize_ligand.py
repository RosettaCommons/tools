...
### Parse the options ###
parser=OptionParser(usage='visualize_ligand.py [PDB-FILE-1] [PDB-FILE-2] ...', description="Generate PyMol session visualizing ligand binding pocket")
...
for file in args:
	...
	# make selections of ligand, binding pocket (all residues with an atom within 4A of ligand) and their polar contacts
