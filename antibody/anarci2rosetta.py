...
# Written by Dave La
# Updated: Fri Sep 14 18:54:38 PDT 2018
...
# intended to be piped into a file and specified and used with the argument 
# "-antibody:json_cdr" in antibody.cc for by-passsing the regular expression used by 
# default to identifying CDR regions.
...
# Usage: anarci2rosetta.py <file.fasta>
...
anarci_cmd = "ANARCI -i " + fasta_file + " --scheme aho";
