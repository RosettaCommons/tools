module maxd_toolbox(input, output);
(*
...
[global] procedure init_residuelist(var firstresidue, lastresidue: residuepointer);
...
[global] function val(s: a4): integer;
var
	i,v: integer;
...
[global] function resnametocode(resnm: a4): integer;
var
...
[global] function atomnametocode(atnm: a4): integer;
var
...
[global] procedure save_backbone(outfilename: string; protein: proteinpointer);
...
[global] procedure transrot(r: xyz; var rnew: xyz; u: rotationmatrix; t: translationvector);
var    
        i,j: integer;
...
[global] procedure matchca(residue1, residue2: residuepointer; length: integer;
...
[global] procedure write_brk(atomname: a4; x: xyz; pdbname: a10; 
...
[global] procedure mainrecord_to_brk(main: main_record; 
...
[global] procedure oldwrite_brk(atomname: a4; x: xyz; resname: a4; chainid: a1;
...
[global] procedure oldmainrecord_to_brk(main: main_record; resname: a4;
...
[global] function str(v: integer): a4;
var
        i: integer;
        aa: packed array[1..11] of char;
        s: a4;
...
[global] function codetoresname(code: integer): a4;
var
        aa: packed array[1..150] of char;
        s: array[1..5] of packed array[1..30] of char;
        i,l,k: integer;
...
[global] function codetoatomname(code: integer): a4;
var
        aa: packed arRay[1..210] of char;
        s: array[1..7] of packed array[1..30] of char;
        i,l,k: integer;
...
[global] function atan2(y,x: real): real;
var     z: real;
begin
...
[global] procedure diff(x,y: xyz; var z: xyz);
begin z[1] := x[1]-y[1]; z[2] := x[2]-y[2]; z[3] := x[3]-y[3]; end;

[global] function dot(x,y: xyz): real;
begin dot := x[1]*y[1]+x[2]*y[2]+x[3]*y[3]; end;

[global] procedure cross(x,y: xyz; var z: xyz);
begin
        z[1] := x[2]*y[3]-y[2]*x[3];
        z[2] := x[3]*y[1]-y[3]*x[1];
        z[3] := x[1]*y[2]-y[1]*x[2];
...
[global] function dihedralangle(v1, v2, v3, v4: xyz): real;
var
        i: integer;
        u, v: real;
        v12, v43, x, y, z, p: xyz;
...
[global] procedure openfile(var filvar: text; filename: string; mode: inout);
var
	x: integer;     
...
[global] procedure make_new_protein(var firstprotein: proteinpointer);
...
[global] procedure make_new_residue(protein: proteinpointer; var firstresidue, lastresidue: residuepointer); 
...
[global] function findresnoresname(protein: proteinpointer; resno: a5; resname: a4): residuepointer;
...
[global] procedure makeside(residue: residuepointer; atnm: a4; cd: xyz); 
var
...
[global] procedure brk_to_list(lastprotein: proteinpointer; 
...
[global] procedure list_to_side(protein: proteinpointer; outfilename: string);
var
...
[global] function distance(a,b: xyz): real;
var
	c: xyz;
	d: real;
	i: integer;
...
[global] procedure backbone_to_list(lastprotein: proteinpointer; var firstresidue: residuepointer; infilename: string; var length: integer);
...
[global] procedure fill_protein_record(protein: proteinpointer; first: residuepointer; proteinname: string; l: integer);
...
[global] procedure side_to_list(protein: proteinpointer; infilename: string);
...
[global] function findproteinpointer(master: string; firstprotein: proteinpointer): proteinpointer;
...
[global] procedure getprotein(master: string; sidechain: boolean; 
...
[global] procedure fill_lookup(var lookup: lookuptable; var dist: distm; nprot: integer;
...
[global] procedure maintodist(master: string);
...
[global] procedure load_distances(var nprot: integer; var master: string;
...
[global] procedure extend_to_rigth(j, begresidue, testlen, length, cutoff1, comparestart, templatestart: integer;
			  var dist: distm;
			  var nright: integer;
			  var s: real);
var
...
[global] procedure extend_to_left(j, begresidue, testlen, length, cutoff1, comparestart, templatestart: integer;
			  var dist: distm;
			  var nleft: integer;
			  var s: real;
			  nright: integer);
...
[global] procedure update_pathsums(start, goal: integer; var fragmentlist: fragmentlistarray);
var
	i: integer;
	smallest, t: real;
...
[global] procedure jump(jumpfrom, jumpto: fragmentpointer; var rms, suurin: real);
var
...
[global] procedure update_jump_fromnewtoold(var fragmentlist: fragmentlistarray; 
...
[global] procedure update_jump_fromoldtonew(var fragmentlist: fragmentlistarray; 
				k, begresidue, testlen: integer;
				var newfragment: fragmentpointer; tolerance: real);
var
...
[global] procedure init_fragmentlist(var fragmentlist: fragmentlistarray; len: integer);
var 	i: integer;
begin	for i := 1 to len do fragmentlist[i] := nil; 
	end;

[global] procedure generate_cb(n, ca, c0: xyz; var cb: xyz);
...
[global] procedure generate_sidechains(ca,cb,c,n: xyz; residue: residuepointer;
...
[global] procedure add_sidechains(protein: proteinpointer; var firstprotein: proteinpointer);
var
	curresidue: residuepointer;
	cb: xyz;
