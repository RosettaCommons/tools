...
def args():
    ...
    change_parser.add_argument("--score_files", "-s", dest="o_files", nargs="+", help="What do you want output to a file?:\n\
    ...
    seqlogo_parser.add_argument("--path", dest="logo_path", default="/blue/meilerlab/apps/scripts_repository/sequence_analysis/weblogo-3.3/weblogo",help="What is the path to weblogo software")
    seqlogo_parser.add_argument("--format", dest="s_format", default="eps",help="What format do you want the sequence logo in? Defaults to eps. Choices=eps,jpg,png,png_print,pdf,jpeg,svg,logodata")
    seqlogo_parser.add_argument("--units", dest="s_units", default="bits",help="What do you want the units of the sequence logo to be in? Defaults to bits. Choices=bits,nats,kt,kJ/mol,kcal/mol,probability")
    ...
    seqlogo_parser.add_argument("--x_axis", dest="s_x_axis", default="",help="What do you want the x axis titled?")
    ...
    seqlogo_parser.add_argument("--color_scheme", dest="s_scheme", default="chemistry",help="The color scheme of the sequence logo. Defaults to Classic. Choices:auto,chemistry,charge,classic,hydrophobicity,monochrome")
    seqlogo_parser.add_argument("--labels", dest="s_labels", default="sequence", help="The x-axis labels can either take on the native residues sequence given with \na native pdb file or the numbering of the pdb residue choice=sequence,number")
    ...
    if arg.logo and ('d' or 'nd' not in arg.o_files):
         parser.exit("for seq logos, you must specifiy a res or corr file...\
            can't possibly generate a seq logo of the entire PDB!")
