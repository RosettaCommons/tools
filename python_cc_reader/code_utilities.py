...
def libraries_with_ccfiles_to_examine() :
   ...
   return [ 'basic', 'core.1', 'core.2', 'core.3', 'core.4', 'core.5', 'protocols', 'devel', 'apps', 'pilot_apps' ]
      ...
      if cr.line_is_visible() :
         if re_pound_include.match( cr.commentless_line ) :
            ...
            if include in file_contents:
               ...
               follow_includes_for_file( include, file_contents, cr, lines, re_pound_include, already_included )
               continue
...
def expand_includes_for_file( file, file_contents ) :
   ...
   re_pound_include = re.compile( "#include" )
   already_included = []
   follow_includes_for_file( file, file_contents, cr, lines, re_pound_include, already_included )
   return lines
