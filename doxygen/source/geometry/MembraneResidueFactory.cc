...
namespace geometry {
    ...
    void MembraneResidueFactory::add_membrane_residue(
		...
		// Get a list of Residue types with VRT type
        core::chemical::ResidueTypeCOPs const & rsd_type_list( residue_set->name3_map("MEM") );
        
        // Create a new residue
        core::conformation::ResidueOP rsd( core::conformation::ResidueFactory::create_residue(*rsd_type_list[1]) );
    ...
    void MembraneResidueFactory::add_embedding_residue(
        ...
        // Create residue type with variant type membrane center
        core::chemical::ResidueType type = *rsd_type_list[1];
        
        // Create a new residue
        core::conformation::ResidueOP rsd( core::conformation::ResidueFactory::create_residue(type) );
