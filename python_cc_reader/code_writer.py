...
class CodeWriter :
    ...
    def rosetta_copyright( self ) :
        lines = []
        lines.append( "// -*- mode:c++;tab-width:2;indent-tabs-mode:t;show-trailing-whitespace:t;rm-trailing-spaces:t -*-\n" )
    ...
    def copy_ctor_for_class( self, cdec ) :
        ...
        if len( cdec.data_members ) :
            ...
            lines.append( "\t" + cdec.data_members[-1][1] + "( src." + cdec.data_members[-1][1] + " )\n" )
        else:
            lines.append( cname + "::" + cname + "( " + cname + " const & src )\n" )
        lines.append( "{}\n" )
        return lines
    ...
    def creator_class_declaration( self, classname, classtype, baseclass ) :
        ...
        lines.append("public:\n")
        lines.append("\tvirtual "+ classtype + "OP create_"+lc_classtype + "() const;\n" )
    ...
    def mover_creator_header_file_for_class( self, cdec ) :
        ...
        lines.append("///@file " + cdec.scope.replace("::","/") + creator_name + ".hh\n")
        lines.append("///@brief This class will create instances of Mover " + cdec.name + " for the MoverFactory\n" )
        lines.append("///@author Andrew Leaver-Fay via code_writer.py (aleaverfay@gmail.com)\n" )
        lines.append( "\n" )
        ...
        lines.append("\n")
        classlines = self.creator_class_header( cdec.name, "Mover", "protocols::moves::MoverCreator" )
