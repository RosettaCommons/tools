...
def add_using_namespaces_to_lines( filename, filelines, input_namespaces = [ "std", "ObjexxFCL", "ObjexxFCL::fmt" ] ) :
   ...
   for line in filelines :
      count_line += 1
      if auto_using_start_line != 0 and count_line >= auto_using_start_line and count_line <= last_auto_using_line :
         continue
...
def add_using_namespaces( filename, input_namespaces = [ "std", "ObjexxFCL", "ObjexxFCL::fmt" ] ) :
   filelines = open( filename, "r" ).readlines()
   namespaces, newlines = add_using_namespaces_to_lines( filename, filelines, input_namespaces )
